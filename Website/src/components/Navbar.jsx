...
export function Navbar() {
  ...
  return (
    <nav
      className="relative flex w-full flex-wrap items-center justify-between bg-zinc-50 py-2 text-neutral-500 shadow-md lg:py-4"
      data-twe-navbar-ref="">
      <div className="flex w-full flex-wrap items-center justify-between px-3">
        ...
        <button
          className="block border-0 bg-transparent px-2 text-black/50"
          type="button"
          ...
          <svg
            ...
            <path
              fillRule="evenodd"
              d="M3 6.75A.75.75 0 013.75 6h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 6.75zM3 12a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 010 1.5H3.75A.75.75 0 013 12zm0 5.25a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75z"
              clipRule="evenodd"
            />
          </svg>
        </button>
        ...
        <div
          ...
          className="!visible mt-2 hidden basis-full lg:mt-0 lg:!flex lg:basis-auto"
          data-twe-collapse-item="">
          <div
            className="flex flex-col gap-4 lg:flex-row lg:items-center"
            data-twe-navbar-nav-ref="">
            <NavLink
              className="text-black hover:text-blue-600 dark:text-white"
              to="/"
