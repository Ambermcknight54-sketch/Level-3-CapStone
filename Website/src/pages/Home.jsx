...
export function Home() {
  return (
    <div className="container mx-auto px-5 py-2 lg:px-32 lg:pt-12">
      ...
      <div className="mx-auto my-8 max-w-xl rounded-lg border border-neutral-200 bg-white p-6 shadow-md dark:border-neutral-700 dark:bg-neutral-800">
        ...
        <p className="mb-4 text-base text-neutral-600 dark:text-neutral-200">
          ...
          craft meets fresh style. By highlighting monthly featured products, we
          bring you handpicked, limited-run pieces and seasonal designs crafted
          to elevate your personal style and keep your look effortlessly up to
          date.
        </p>
      </div>
    </div>
